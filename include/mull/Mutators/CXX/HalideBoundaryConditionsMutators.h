...
/// The classes below therefore carry no low-level IR mutation and exist so that
/// the mutator identifiers, the halide_boundary_conditions group and the
/// reporters all resolve.
